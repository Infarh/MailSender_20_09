...
namespace MailSender.lib.Reports
{
    ...
    {
        public int SendedMailsCount { get; set; }
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00EB41FE", RsidParagraphAddition = "00057E8C", RsidParagraphProperties = "00EB41FE", RsidRunAdditionDefault = "00B75318", ParagraphId = "62DA7E25", TextId = "790C1ADE" };
            ...
            Run run1 = new Run() { RsidRunProperties = "00EB41FE" };
            ...
            text1.Text = "Отчёт приложения отправки почты ";

            run1.Append(runProperties1);
            run1.Append(text1);

            Run run2 = new Run() { RsidRunProperties = "00EB41FE", RsidRunAddition = "00884384" };
            ...
            Run run3 = new Run() { RsidRunProperties = "00EB41FE" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00884384", RsidRunAdditionDefault = "00884384", ParagraphId = "138F1D00", TextId = "606FAD42" };

            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "00884384", RsidParagraphAddition = "00884384", RsidRunAdditionDefault = "00884384", ParagraphId = "3756AB7F", TextId = "6A3C2208" };
            ...
            Run run4 = new Run() { RsidRunProperties = "00EB41FE" };
            ...
            text4.Text = "Отправлено сообщений ";
            ...
            Text text6 = new Text();
            text6.Text = SendedMailsCount.ToString();
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00884384", RsidR = "00884384" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00251A3A" };
            Rsid rsid1 = new Rsid() { Val = "00057E8C" };
            Rsid rsid2 = new Rsid() { Val = "00251A3A" };
            Rsid rsid3 = new Rsid() { Val = "00884384" };
            Rsid rsid4 = new Rsid() { Val = "008D68B1" };
            Rsid rsid5 = new Rsid() { Val = "00B75318" };
            Rsid rsid6 = new Rsid() { Val = "00EB41FE" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "08C147E0" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{2DCD4DFB-177D-47D4-9B93-630B8465D1D2}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            runPropertiesBaseStyle1.Append(fontSize5);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript5);
            ...
            Rsid rsid7 = new Rsid() { Val = "008D68B1" };
            ...
            styleRunProperties1.Append(fontSize6);
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-10-16T17:12:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-10-16T17:13:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
